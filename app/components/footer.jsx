        ...
        <div className="md:flex bg-redWine">
            <div className="flex md:w-9/12 justify-center border-r-2">
                ...
                <div className="flex items-center">
                    <h3 className="mx-3">Powered by:</h3>
                    <ImageTDSF></ImageTDSF>
                </div>
            </div>
            <div className="my-5 flex md:w-3/12 justify-center items-center">
                <div>
                    <div className="flex justify-center items-center my-4">
                        <h2 className="md:mx-3">Siguenos en:</h2>
                    ...
                    <div className="md:mx-3 my-4 items-center">
                        <h2 className="text-center md:text-left">@DinastiaShoes2023</h2>
                    </div>
                </div>
            </div>
        </div>
...
const InstagramIcon = () => {
    return <svg className="mx-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
