const View = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" className="bi bi-eye-fill" viewBox="0 0 16 16">
...
export default function TableAction(props){
    ...
    return(
        <span className="inline-block cursor-pointer" onClick={action}>
            {svg}
        </span>
    );
}